...
export default function Home() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("originMint_brands");
    if (saved) {
      try {
  ...
  const saveBrandToHistory = (newBrand) => {
    ...
    localStorage.setItem("originMint_brands", JSON.stringify(updated));
  };
...
---------------------------------------------
Generated by OriginMint AI. Define your startup idea and get your brand identity.
    `;
